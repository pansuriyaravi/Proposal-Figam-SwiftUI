...
public extension WrappingHStack {
    ...
    init<A: View, B: View, C: View, D: View, E: View>(
        ...
        horizontalSpacing: CGFloat = 0,
        isScollable: Bool = false,
        @ViewBuilder content: @escaping () -> TupleView<(A, B, C, D, E)>
    ) {
        self.spacing = spacing
        self.lineSpacing = lineSpacing
        self.alignment = alignment
    ...
    init<A: View, B: View, C: View, D: View, E: View, F: View>(
        ...
        horizontalSpacing: CGFloat = 0,
        isScollable: Bool = false,
        @ViewBuilder content: @escaping () -> TupleView<(A, B, C, D, E, F)>
    ) {
        self.spacing = spacing
        self.lineSpacing = lineSpacing
        self.alignment = alignment
    ...
    init<A: View, B: View, C: View, D: View, E: View, F: View, G: View>(
        ...
        horizontalSpacing: CGFloat = 0,
        isScollable: Bool = false,
        @ViewBuilder content: @escaping () -> TupleView<(A, B, C, D, E, F, G)>
    ) {
        self.spacing = spacing
        self.lineSpacing = lineSpacing
        self.alignment = alignment
    ...
    init<A: View, B: View, C: View, D: View, E: View, F: View, G: View, H: View>(
        ...
        horizontalSpacing: CGFloat = 0,
        isScollable: Bool = false,
        @ViewBuilder content: @escaping () -> TupleView<(A, B, C, D, E, F, G, H)>
    ) {
        self.spacing = spacing
        self.lineSpacing = lineSpacing
        self.alignment = alignment
    ...
    init<A: View, B: View, C: View, D: View, E: View, F: View, G: View, H: View, I: View>(
        ...
        horizontalSpacing: CGFloat = 0,
        isScollable: Bool = false,
        @ViewBuilder content: @escaping () -> TupleView<(A, B, C, D, E, F ,G, H, I)>
    ) {
        self.spacing = spacing
        self.lineSpacing = lineSpacing
        self.alignment = alignment
    ...
    init<A: View, B: View, C: View, D: View, E: View, F: View, G: View, H: View, I: View, J: View>(
        alignment: HorizontalAlignment = .leading,
        spacing: Spacing = .constant(8),
        lineSpacing: CGFloat = 0,
        horizontalSpacing: CGFloat = 0,
        isScollable: Bool = false,
        @ViewBuilder content: @escaping () -> TupleView<(A, B, C, D, E, F ,G, H, I, J)>
    ) {
        self.spacing = spacing
        self.lineSpacing = lineSpacing
        self.alignment = alignment
...
struct WrappingHStack_Preview: PreviewProvider{
    static var previews: some View{
        WrappingHStack(0...100, lineSpacing: 16) { index in
        ...
        WrappingHStack(0...100, lineSpacing: 16, horizontalSpacing: 16, isScollable: true) { index in
            Text(index.description)
                .padding(.horizontal)
                .foregroundColor(.white)
                .background(Color.blue)
